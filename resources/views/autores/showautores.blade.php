      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="col-md-12 text-center">
            <a href="autores/create" class="btn btn-dark text-capitalize border border-left border-right
              ...
              @foreach($autores as $datos)
                <tr>
                  ...
                  <div class="d-flex">
                      ...
                      border-top border-bottom border-light rounded-lg active text-decoration-none py-1"><i class="bi-pencil"></i><a href="{{route('autores.edit',$datos->id)}}"></i></a></button>
